		...
		if (reads2 == "-")
			if (params.qc_fastqc_quiet)
				if (params.qc_fastqc_nogroup)
					...
					fastqc -t $task.cpus -k $params.qc_fastqc_kmers -q --nogroup -o ${sampleId}_${sampleReplicate}_${sampleTimepoint} $reads1f &> ${sampleId}_${sampleReplicate}_${sampleTimepoint}/${sampleId}_${sampleReplicate}_${sampleTimepoint}.fastqc.log
					"""
				else
					"""
					mkdir -p ${sampleId}_${sampleReplicate}_${sampleTimepoint}
					fastqc -t $task.cpus -k $params.qc_fastqc_kmers -q -o ${sampleId}_${sampleReplicate}_${sampleTimepoint} $reads1f &> ${sampleId}_${sampleReplicate}_${sampleTimepoint}/${sampleId}_${sampleReplicate}_${sampleTimepoint}.fastqc.log
					"""
			else
				if (params.qc_fastqc_nogroup)
					"""
					mkdir -p ${sampleId}_${sampleReplicate}_${sampleTimepoint}
					fastqc -t $task.cpus -k $params.qc_fastqc_kmers --nogroup -o ${sampleId}_${sampleReplicate}_${sampleTimepoint} $reads1f &> ${sampleId}_${sampleReplicate}_${sampleTimepoint}/${sampleId}_${sampleReplicate}_${sampleTimepoint}.fastqc.log
					"""
				else
					"""
					mkdir -p ${sampleId}_${sampleReplicate}_${sampleTimepoint}
					fastqc -t $task.cpus -k $params.qc_fastqc_kmers -o ${sampleId}_${sampleReplicate}_${sampleTimepoint} $reads1f &> ${sampleId}_${sampleReplicate}_${sampleTimepoint}/${sampleId}_${sampleReplicate}_${sampleTimepoint}.fastqc.log
					"""
		else
			if (params.qc_fastqc_quiet)
				if (params.qc_fastqc_nogroup)
					"""
					mkdir -p ${sampleId}_${sampleReplicate}_${sampleTimepoint}
					fastqc -t $task.cpus -k $params.qc_fastqc_kmers -q --nogroup -o ${sampleId}_${sampleReplicate}_${sampleTimepoint} $reads1f $reads2f &> ${sampleId}_${sampleReplicate}_${sampleTimepoint}/${sampleId}_${sampleReplicate}_${sampleTimepoint}.fastqc.log
					"""
				else
					"""
					mkdir -p ${sampleId}_${sampleReplicate}_${sampleTimepoint}
					fastqc -t $task.cpus -k $params.qc_fastqc_kmers -q -o ${sampleId}_${sampleReplicate}_${sampleTimepoint} $reads1f $reads2f &> ${sampleId}_${sampleReplicate}_${sampleTimepoint}/${sampleId}_${sampleReplicate}_${sampleTimepoint}.fastqc.log
					"""
			else
				if (params.qc_fastqc_nogroup)
					"""
					mkdir -p ${sampleId}_${sampleReplicate}_${sampleTimepoint}
					fastqc -t $task.cpus -k $params.qc_fastqc_kmers --nogroup -o ${sampleId}_${sampleReplicate}_${sampleTimepoint} $reads1f $reads2f &> ${sampleId}_${sampleReplicate}_${sampleTimepoint}/${sampleId}_${sampleReplicate}_${sampleTimepoint}.fastqc.log
					"""
				else
					"""
					mkdir -p ${sampleId}_${sampleReplicate}_${sampleTimepoint}
					fastqc -t $task.cpus -k $params.qc_fastqc_kmers -o ${sampleId}_${sampleReplicate}_${sampleTimepoint} $reads1f $reads2f &> ${sampleId}_${sampleReplicate}_${sampleTimepoint}/${sampleId}_${sampleReplicate}_${sampleTimepoint}.fastqc.log
					"""
}
		...
		if (reads2 == "-")
			if (params.qc_fastqc_quiet)
				if(params.qc_trim_use_adapter)
					"""
					mkdir -p ${sampleId}_${sampleReplicate}_${sampleTimepoint}
					trimmomatic SE -threads $task.cpus -quiet $reads1f ${sampleId}_${sampleReplicate}_${sampleTimepoint}/${sampleId}_${sampleReplicate}_${sampleTimepoint}.SE.fq ILLUMINACLIP:${trim_adapter_file}:${params.qc_clip_options} ${params.qc_trim_options} &> ${sampleId}_${sampleReplicate}_${sampleTimepoint}/${sampleId}_${sampleReplicate}_${sampleTimepoint}.trim.log
					bgzip ${sampleId}_${sampleReplicate}_${sampleTimepoint}/${sampleId}_${sampleReplicate}_${sampleTimepoint}.SE.fq
					"""
				else
					"""
					mkdir -p ${sampleId}_${sampleReplicate}_${sampleTimepoint}
					trimmomatic SE -threads $task.cpus -quiet $reads1f ${sampleId}_${sampleReplicate}_${sampleTimepoint}/${sampleId}_${sampleReplicate}_${sampleTimepoint}.SE.fq ${params.qc_trim_options} &> ${sampleId}_${sampleReplicate}_${sampleTimepoint}/${sampleId}_${sampleReplicate}_${sampleTimepoint}.trim.log
					bgzip ${sampleId}_${sampleReplicate}_${sampleTimepoint}/${sampleId}_${sampleReplicate}_${sampleTimepoint}.SE.fq
					"""
			else
				if(params.qc_trim_use_adapter)
					...
					"""
					mkdir -p ${sampleId}_${sampleReplicate}_${sampleTimepoint}
					trimmomatic SE -threads $task.cpus $reads1f ${sampleId}_${sampleReplicate}_${sampleTimepoint}/${sampleId}_${sampleReplicate}_${sampleTimepoint}.SE.fq ${params.qc_trim_options} &> ${sampleId}_${sampleReplicate}_${sampleTimepoint}/${sampleId}_${sampleReplicate}_${sampleTimepoint}.trim.log
					bgzip ${sampleId}_${sampleReplicate}_${sampleTimepoint}/${sampleId}_${sampleReplicate}_${sampleTimepoint}.SE.fq
					"""
		else
			if (params.qc_fastqc_quiet)
...
process PEAR {
	...
	script:
		if (reads2 == "-")
			...
			"""
			pear --threads $task.cpus ${params.qc_pear_options} -f ${sampleId}_${sampleReplicate}_${sampleTimepoint}/${sampleId}_${sampleReplicate}_${sampleTimepoint}.PE1.fq.gz -r ${sampleId}_${sampleReplicate}_${sampleTimepoint}/${sampleId}_${sampleReplicate}_${sampleTimepoint}.PE2.fq.gz -o ${sampleId}_${sampleReplicate}_${sampleTimepoint}/${sampleId}_${sampleReplicate}_${sampleTimepoint} &> ${sampleId}_${sampleReplicate}_${sampleTimepoint}/${sampleId}_${sampleReplicate}_${sampleTimepoint}.pear.log
